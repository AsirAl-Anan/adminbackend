...
const VhashonRochonaSchema = new mongoose.Schema({
    name: {
        en: {
            type: String,
            required: true,
    ...
    startingPoints: [{ type: String, trim: true }],
    content: { type: String },
    source: sourceSchema,
});

const VhashonRochona = academicDb.model("VhashonRochona", VhashonRochonaSchema);

export default VhashonRochona;
