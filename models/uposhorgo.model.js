...
const uposhorgoQuestionSchema = new mongoose.Schema({
...
const excersizeSchema = new mongoose.Schema({
    ...
    uposhorgos: [uposhorgoQuestionSchema],
    _id: false,
});

const uposhorgoSchema = new mongoose.Schema({
    name: {
        en: {
            type: String,
            required: true,
...
const Uposhorgo = academicDb.model("Uposhorgo", uposhorgoSchema);

export default Uposhorgo;