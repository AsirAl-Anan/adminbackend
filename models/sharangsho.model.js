...
const SharangshoSchema = new mongoose.Schema({
    name: {
        en: {
            type: String,
            required: true,
    ...
    importantSpellings: [{ type: String, trim: true }],
    content: { type: String },
    meaning: { type: String },
    source: sourceSchema,
});

const Sharangsho = academicDb.model("Sharangsho", SharangshoSchema);

export default Sharangsho;
