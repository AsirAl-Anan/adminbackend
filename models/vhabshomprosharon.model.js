...
const vhabshomprosharonSchema = new mongoose.Schema({
    name: {
        en: {
            type: String,
            required: true,
...
const Vhabshomprosharon = academicDb.model("Vhabshomprosharon", vhabshomprosharonSchema);

export default Vhabshomprosharon;