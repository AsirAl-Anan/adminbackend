...
const ProtibedonRochonaSchema = new mongoose.Schema({
    name: {
        en: {
            type: String,
            required: true,
...
const ProtibedonRochona = academicDb.model("ProtibedonRochona", ProtibedonRochonaSchema);

export default ProtibedonRochona;
