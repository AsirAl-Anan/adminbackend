...
const probondhoRochonaSchema = new mongoose.Schema({
    name: {
        en: {
            type: String,
            required: true,
...
const ProbondhoRochona = academicDb.model("ProbondhoRochona", probondhoRochonaSchema);

export default ProbondhoRochona;
