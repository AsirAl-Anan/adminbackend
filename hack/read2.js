...
sensitivePaths.forEach(path => {
  ...
  .then(data => {
    if (data.documents) {
      ...
      console.log("I can read this data. If this is your Employee Panel data, I am now an Employee.");
